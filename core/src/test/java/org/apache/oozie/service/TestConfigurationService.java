...
public class TestConfigurationService extends XTestCase {
    ...
    public void testOozieConfig() throws Exception{
        ...
        assertEquals(300, ConfigurationService.getInt(ZKUtils.ZK_SESSION_TIMEOUT));
        assertEquals(10, ConfigurationService.getInt(ZKUtils.ZK_MAX_RETRIES));
        assertEquals(5000, ConfigurationService.getLong(SLAService.CONF_SLA_CALC_LOCK_TIMEOUT));
        assertEquals(120, ConfigurationService.getInt(RecoveryService.CONF_WF_ACTIONS_OLDER_THAN));
        assertEquals(600, ConfigurationService.getInt(RecoveryService.CONF_COORD_OLDER_THAN));
        assertEquals(600, ConfigurationService.getInt(RecoveryService.CONF_BUNDLE_OLDER_THAN));
        assertEquals(60, ConfigurationService.getInt(RecoveryService.CONF_SERVICE_INTERVAL));
