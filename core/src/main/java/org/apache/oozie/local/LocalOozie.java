...
public class LocalOozie {
     ...
     * @throws Exception
     */
    public synchronized static void start(XConfiguration oozieConf, Object... servletPathAndClass) throws Exception {
        ...
        start(oozieConf, servletPathClassMap);
    }
     ...
     * @throws Exception if LocalOozie could not be started.
     */
    public synchronized static void start(XConfiguration oozieConf, Map<String,Class> servletPathClassMap) throws Exception {
        if (localOozieActive) {
